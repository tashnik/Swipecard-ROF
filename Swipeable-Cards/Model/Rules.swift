...
struct Rules {
  ...
  static let rule5 = "Thumber! 👍 Puteth your thumb on something before the next 5 gets drawn. The last person to thumb what you thumbed, drinks."
  static let rule6 = "All those who identifieth as a King drink. 🤴"
  ...
  static let rule9 = "Rhyme Thyme! 🎤 Think of a word then go around the court rhyming that word until someone messes up and has to drink."
  static let rule10 = "Categories! 🤔 Go around the court naming things belonging to a category until someone messes up and has to drink."
  ...
  static let ruleKing = "👑 Poureth a quarter of your drink into the King's Cup.  Yikes..."
